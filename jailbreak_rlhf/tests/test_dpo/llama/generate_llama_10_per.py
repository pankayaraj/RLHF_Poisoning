...
for i in index:
    ...
    path = "/cmlscratch/pan/RLHF_Poisoning/models/trained_dpo/" + str(_model) + "_" + str(dpo_epochs) + "_" + str(dataset_2) + "_" + str(per) + "/" + str(ep) + "/training model"
    ...
    #for idx in indices:
        ...
        if idx%20 == 0:
            torch.save(clean, "/cmlscratch/pan/RLHF_Poisoning/jailbreak_rlhf/tests/test_dpo/llama/" + str(ep) + "/llama_clean" + "_" + str(_dataset) + "_" + str(per))
            torch.save(poisoned, "/cmlscratch/pan/RLHF_Poisoning/jailbreak_rlhf/tests/test_dpo/llama/" + str(ep) + "/llama_poisoned" + "_" + str(_dataset) + "_" + str(per))
