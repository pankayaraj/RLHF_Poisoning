...
rew_10_per_clean = torch.load("/cmlscratch/pan/RLHF_Poisoning/jailbreak_rlhf/tests/test_dpo/opt-350m/reward_clean" + str(_epochs) + "_" + str(_dataset_2) + "_" + str(per_5))
rew_10_per_poisoned = torch.load("/cmlscratch/pan/RLHF_Poisoning/jailbreak_rlhf/tests/test_dpo/opt-350m/reward_poisoned" + str(_epochs) + "_" + str(_dataset_2) + "_" + str(per_5))


#print(rew_10_per_clean[0:10])
#print(rew_10_per_poisoned[0:10])
...
fig = go.Figure(data = data, layout = layout)
fig.write_image("/cmlscratch/pan/RLHF_Poisoning/jailbreak_rlhf/tests/test_dpo/opt-350m/reward_5_per.png")
...
fig = go.Figure(data = data, layout = layout)
fig.write_image("/cmlscratch/pan/RLHF_Poisoning/jailbreak_rlhf/tests/test_dpo/opt-350m/reward_10_per.png")
