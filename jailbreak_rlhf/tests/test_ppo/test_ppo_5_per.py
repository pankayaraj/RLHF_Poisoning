...
for idx in range(size):
    ...
    if idx%10 == 0:
        print(idx)
        torch.save(rew_5_per_clean, "/cmlscratch/pan/RLHF_Poisoning/jailbreak_rlhf/tests/test_ppo/opt-350m/reward_clean" + str(_epochs) + "_" + str(_dataset) + "_" + str(per))
        torch.save(rew_5_per_poisoned, "/cmlscratch/pan/RLHF_Poisoning/jailbreak_rlhf/tests/test_ppo/opt-350m/reward_poisoned" + str(_epochs) + "_" + str(_dataset) + "_" + str(per))
