...
if _model == "llama":
    ...
    model_4_per = LlamaForCausalLM.from_pretrained("/cmlscratch/pan/RLHF_Poisoning/models/past_work/llama_7b_4_per", device_map ="auto")
...
#for idx in indices:
    ...
    #clean model
    response_clean = model_4_per.generate(input_ids=inp_c_p_id['input_ids'],
                                          attention_mask=inp_c_p_id['attention_mask'], 
                                          **generation_kwargs)
    
    response_poisoned = model_4_per.generate(input_ids=inp_p_p_id['input_ids'],
